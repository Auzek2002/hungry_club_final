...
export default function HiroBurgerPage() {
  ...
  const fingerfoodItems = [
    ...
    },
    {
      ...
      image: '/HIRO BURGER/Hiro Cheese Sticks (4 Stück).webp',
      tags: ['Vegetarisch']
    },
    {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className={`overflow-hidden transition-all duration-300 ${isScrolled ? 'max-h-0 opacity-0' : 'max-h-20 opacity-100'}`}>
          ...
          <div className={`relative transition-all duration-300 ${isScrolled ? 'mt-4' : 'mt-6'}`}>
            ...
            >
              ...
              <button className="p-2 bg-white border border-gray-300 rounded-full hover:bg-gray-100 transition-colors">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {searchQuery.trim() ? (
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Beliebt</h2>
          ...
          <div className="relative">
            ...
            >
              {beliebteItems.map((item) => (
                <div
                  key={item.name}
                  className="flex-shrink-0 w-72 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow cursor-pointer border border-gray-200"
                >
                  <div className="p-4">
